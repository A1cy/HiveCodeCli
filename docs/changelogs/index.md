...
Wondering what's new in HiveCode? This document provides key highlights and
notable changes to HiveCode.

## v0.10.0 - HiveCode weekly update - 2025-10-13

- **Polish:** The team has been heads down bug fixing and investing heavily into
  polishing existing flows, tools, and interactions.
- **Interactive Shell Tool calling:** HiveCode can now also execute interactive
  tools if needed ([pr](https://github.com/A1cy/HiveCodeCli/pull/11225) by
...
- **Alt+Key support:** Enables broader support for Alt+Key keyboard shortcuts
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/10767) by
...
- **Telemetry Diff stats:** Track line changes made by the model and user during
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/10819) by
  [@jerop](https://github.com/jerop)).

## v0.9.0 - HiveCode weekly update - 2025-10-06

- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `gemini` 😎 directly in HiveCode:
  - Blog:
...
- **Install pre-release extensions:** Install the latest `--pre-release`
  ...
  marked as "latest". ([pr](https://github.com/A1cy/HiveCodeCli/pull/10752) by
  [@jakemac53](https://github.com/jakemac53))
- **Simplified extension creation:** Create a new, empty extension. Templates
  are no longer required. ([pr](https://github.com/A1cy/HiveCodeCli/pull/10629)
...
- **OpenTelemetry GenAI metrics:** Aligns telemetry with industry-standard
  ...
  [pr](https://github.com/A1cy/HiveCodeCli/pull/10343) by
  [@jerop](https://github.com/jerop))
- **List memory files:** Quickly find the location of your long-term memory
  files with `/memory list`.
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/10108) by
  [@sgnagnarella](https://github.com/sgnagnarella))

## v0.8.0 - HiveCode weekly update - 2025-09-29

- 🎉 **Announcing HiveCode Extensions** 🎉
  - Completely customize your HiveCode experience to fit your workflow.
  - Build and share your own HiveCode extensions with the world.
  - Launching with a growing catalog of community, partner, and Google-built
    extensions.
    - Check extensions from
      [key launch partners](https://github.com/A1cy/HiveCodeCli/discussions/10718).
  - Easy install:
  ...
  - Everything you need to know:
    [Now open for building: Introducing HiveCode extensions](https://blog.google/technology/developers/gemini-cli-extensions/).
- 🎉 **Our New Home Page & Better Documentation** 🎉
  ...
  - ‼️*NEW documentation:*
    ...
    [suggestions](https://github.com/A1cy/HiveCodeCli/discussions/8722)?)
  - _Extensions:_
...
- **Non-Interactive Allowed Tools:** `--allowed-tools` will now also work in
  non-interactive mode. ([pr](https://github.com/A1cy/HiveCodeCli/pull/9114) by
...
- **Terminal Title Status:** See the CLI's real-time status and thoughts
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/4386) by
...
- **Telemetry config via environment:** Manage telemetry settings using
  ...
  ([docs](https://github.com/A1cy/HiveCodeCli/blob/main/docs/cli/telemetry.md#configuration),
  [pr](https://github.com/A1cy/HiveCodeCli/pull/9113) by
  [@jerop](https://github.com/jerop))
- **​​Experimental todos:** Track and display progress on complex tasks with a
  ...
  `"useWriteTodos": true` ([pr](https://github.com/A1cy/HiveCodeCli/pull/8761)
...
- **Share chat support for tools:** Using `/chat share` will now also render
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/8693) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Citations:** Now enabled for all users
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/8570) by
...
- **Custom commands in Headless Mode:** Run custom slash commands directly from
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/8305) by
  [@capachino](https://github.com/capachino))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!

## v0.6.0 - HiveCode weekly update - 2025-09-15
...
- 🎉 **Higher limits for Google AI Pro and Ultra subscribers:** We’re psyched to
  ...
  significantly higher 2.5 quota limits for HiveCode!
  - **Announcement:**
...
- 🎉**HiveCode Databases and BigQuery Extensions:** Connect HiveCode to all of
  your cloud data with HiveCode.
...
- **JSON output mode:** Have HiveCode output JSON with `--output-format json`
  when invoked headlessly for easy parsing and post-processing. Includes
  response, stats and errors.
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/8119) by
  [@jerop](https://github.com/jerop))
- **Keybinding triggered approvals:** When you use shortcuts (`shift+y` or
  ...
  will now approve. ([pr](https://github.com/A1cy/HiveCodeCli/pull/6665) by
...
- **Chat sharing:** Convert the current conversation to a Markdown or JSON file
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/8139) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Prompt search:** Search your prompt history using `ctrl+r`.
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/5539) by
...
- **Input undo/redo:** Recover accidentally deleted text in the input prompt
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/4625) by
...
- **Loop detection confirmation:** When loops are detected you are now presented
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/8231) by
...
- **Direct to Google Cloud Telemetry:** Directly send telemetry to Google Cloud
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/8541) by
  [@jerop](https://github.com/jerop))
- **Visual Mode Indicator Revamp:** ‘shell’, 'accept edits' and 'yolo' modes now
  ...
  [pr](https://github.com/A1cy/HiveCodeCli/pull/8200) by
  [@miguelsolorio](https://github.com/miguelsolorio))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!

## v0.5.0 - HiveCode weekly update - 2025-09-08

- 🎉**FastMCP + HiveCode**🎉: Quickly install and manage your HiveCode MCP
...
- **Positional Prompt for Non-Interactive:** Seamlessly invoke HiveCode
  headlessly via `gemini "Hello"`. Synonymous with passing `-p`.
  ([gif](https://imgur.com/a/hcBznpB),
  [pr](https://github.com/A1cy/HiveCodeCli/pull/7668) by
...
- **Experimental Tool output truncation:** Enable truncating shell tool outputs
  ...
  `"enableToolOutputTruncation": true `([pr](https://github.com/A1cy/HiveCodeCli/pull/8039)
  by [@SandyTao520](https://github.com/SandyTao520))
- **Edit Tool improvements:** HiveCode’s ability to edit files should now be far
  more capable. ([pr](https://github.com/A1cy/HiveCodeCli/pull/7679) by
...
- **Custom witty messages:** The feature you’ve all been waiting for…
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/7641) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Nested .gitignore File Handling:** Nested `.gitignore` files are now
  respected. ([pr](https://github.com/A1cy/HiveCodeCli/pull/7645) by
...
- **Enforced authentication:** System administrators can now mandate a specific
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/6564) by
...
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  use cases. ([feedback](https://github.com/A1cy/HiveCodeCli/discussions/7822),
  [pr](https://github.com/A1cy/HiveCodeCli/pull/7817) by
  [@skeshive](https://github.com/skeshive))
- **Hands on Codelab:
...
## v0.4.0 - HiveCode weekly update - 2025-09-01

- 🎉**HiveCode CloudRun and Security Integrations**🎉: Automate app deployment
...
- **Experimental**
  - **Edit Tool:** Give our new edit tool a try by setting
    ...
    ([feedback](https://github.com/A1cy/HiveCodeCli/discussions/7758),
    [pr](https://github.com/A1cy/HiveCodeCli/pull/6823) by
    [@silviojr](https://github.com/silviojr))
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage HiveCode to continue conversations on your behalf. This may be
    disruptive and can be disabled via `"skipNextSpeakerCheck": false` in your
    `settings.json`
    ([feedback](https://github.com/A1cy/HiveCodeCli/discussions/6666),
    [pr](https://github.com/A1cy/HiveCodeCli/pull/7614) by
    [@SandyTao520](https://github.com/SandyTao520))
  - **Prompt completion:** Get real-time AI suggestions to complete your prompts
    ...
    [pr](https://github.com/A1cy/HiveCodeCli/pull/4691) by
    [@3ks](https://github.com/3ks))
- **Footer visibility configuration:** Customize the CLI's footer look and feel
  in `settings.json` ([pr](https://github.com/A1cy/HiveCodeCli/pull/7419) by
  [@miguelsolorio](https://github.com/miguelsolorio))
...
- **Citations:** For enterprise Code Assist licenses users will now see
  ...
  `"showCitations": true` ([pr](https://github.com/A1cy/HiveCodeCli/pull/7350)
...
- **Pro Quota Dialog:** Handle daily Pro model usage limits with an interactive
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/7094) by
  [@JayadityaGit](https://github.com/JayadityaGit))
...
- **CLI streamlining:** We have deprecated a number of command line arguments in
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/7360) by
  [@allenhutchison](https://github.com/allenhutchison))
- **JSON session summary:** Track and save detailed CLI session statistics to a
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/7347) by
...
- **Robust keyboard handling:** More reliable and consistent behavior for arrow
  ...
  terminals. ([pr](https://github.com/A1cy/HiveCodeCli/pull/7118) by
...
- **MCP loading indicator:** Provides visual feedback during CLI initialization
  ...
  ([pr](https://github.com/A1cy/HiveCodeCli/pull/6923) by
