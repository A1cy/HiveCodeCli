...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .hivecodeignore files in context (/settings)...',
  ...
  'Show HiveCode status in the terminal window title (/settings)...',
  ...
  'Create a project-specific HIVECODE.md file with /init...',
  ...
  'Reload instructional context from HIVECODE.md files with /memory refresh...',
  'List the paths of the HIVECODE.md files in use with /memory list...',
