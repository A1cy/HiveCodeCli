...
vi.mock('../tools/memoryTool.js', () => ({
  getCurrentGeminiMdFilename: vi.fn(() => 'HIVECODE.md'),
}));
...
describe('FileExclusions', () => {
  ...
  describe('getDefaultExcludePatterns', () => {
    it('should return comprehensive patterns by default', () => {
      ...
      expect(patterns).toContain('**/HIVECODE.md');
    });
    ...
    it('should respect includeDefaults option', () => {
      ...
      expect(patterns).not.toContain('**/HIVECODE.md');
    ...
    it('should respect includeDynamicPatterns option', () => {
      ...
      expect(patternsWithDynamic).toContain('**/HIVECODE.md');
      expect(patternsWithoutDynamic).not.toContain('**/HIVECODE.md');
    });
  });
